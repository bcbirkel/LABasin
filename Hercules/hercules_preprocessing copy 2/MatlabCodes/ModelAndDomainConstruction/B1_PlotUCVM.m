...
% Load XYZ mesh data
Mesh = load(['/home/dude/alanjuar/Doctorate/EarthquakePhysics/Codes/AuxFiles/VelModelCoords.xyz']);
X = Mesh(:,1);
Y = Mesh(:,2);
clear Mesh;

% Load Earthquake database
load /home/dude/alanjuar/Doctorate/EarthquakePhysics/Codes/DataPreparation/EarthquakeDatabase.mat;

% Loading information of the simulation box
FileID = fopen('/home/dude/alanjuar/Doctorate/EarthquakePhysics/Codes/AuxFiles/XYtoLonLat.txt');
...
% Load UCVM model
fileID = fopen('/home/dude/alanjuar/Doctorate/EarthquakePhysics/Codes/AuxFiles/ModelOut.out','r');
...
elev=load ('/home/dude/alanjuar/Doctorate/EarthquakePhysics/Resources/Topography/etopo1_bedrock.xyz');
...
load('/home/dude/alanjuar/Doctorate/EarthquakePhysics/Resources/RollinsData/caldata.mat');
