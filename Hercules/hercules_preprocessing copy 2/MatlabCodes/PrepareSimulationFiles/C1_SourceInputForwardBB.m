...
load /Users/bcbirkel/Documents/GitHub/LABasin/Hercules/hercules_preprocessing/MatlabCodes/DataPreparation/Parameters.mat;
...
Finp = fileread('/Users/bcbirkel/Documents/GitHub/LABasin/Hercules/hercules_preprocessing/MatlabCodes/AuxFiles/inputHPC.in');
...
p = 1;
for n = 1:nPlane
        fileID = fopen(['/Users/bcbirkel/Documents/GitHub/LABasin/Hercules/hercules_preprocessing/MatlabCodes/AuxFiles/planeinputcoords.' num2str(p)],'w');
        fprintf(fileID,'%i\t',0);
        fprintf(fileID,'%i\t',1);
...
PathSim = '/Users/bcbirkel/Documents/GitHub/LABasin/Hercules/currentSim/Simulation/';
mkdir(PathSim);
...
for ns = 1:size(Eqk,1)
    ...
    %Mesh of the domain
    for iP = 1:nPlane
        system(['cp /Users/bcbirkel/Documents/GitHub/LABasin/Hercules/hercules_preprocessing/MatlabCodes/AuxFiles/planeinputcoords.* .']);
    end
