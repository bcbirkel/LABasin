...
load /home/scec-00/birkel/hercules_preprocessing/MatlabCodes/DataPreparation/Parameters.mat;
...
Finp = fileread('/home/scec-00/birkel/hercules_preprocessing/MatlabCodes/AuxFiles/inputHPC.in');
...
p = 1;
for n = 1:nPlane
        fileID = fopen(['/home/scec-00/birkel/hercules_preprocessing/MatlabCodes/AuxFiles/planeinputcoords.' num2str(p)],'w');
        fprintf(fileID,'%i\t',0);
        fprintf(fileID,'%i\t',1);
...
PathSim = '/home/scec-00/birkel/Simulations/';
mkdir(PathSim);
...
for ns = 1:size(Eqk,1)
    ...
    %Mesh of the domain
    for iP = 1:nPlane
        system(['cp /home/scec-00/birkel/hercules_preprocessing/MatlabCodes/AuxFiles/planeinputcoords.* .']);
    end
