...
for nS = 1:size(Eqk,1)
    ...
    for nr = 1:size(In,1)-1
        ...
        for nc = 1:In(nr+1)-In(nr)
            ...
            if isfile(['/Users/bcbirkel/Documents/GitHub/LABasin/Hercules/currentSim/ObsData/Velocity/' ...
               ...
               Sac = rsac('little-endian',['/Users/bcbirkel/Documents/GitHub/LABasin/Hercules/currentSim/ObsData/Velocity/' ...
                ...
                Wave(nc,:) = transfer(W.*rtrend(Sac(1:NT)),NT,1/Dt,['/Users/bcbirkel/Documents/GitHub/LABasin/Hercules/currentSim/ObsData/Velocity/' ...
