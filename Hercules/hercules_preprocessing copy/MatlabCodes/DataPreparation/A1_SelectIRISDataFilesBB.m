...
for nS = 1:size(Eqk,1)
    ...
    PZ_Files = dir(['/Users/bcbirkel/Documents/GitHub/LABasin/Hercules/currentSim/ObsData/Velocity/SACPZ*']);
    ...
    for nf = 1:size(PZ_Files,1)
        ...
        % Open SACPZ File
        Fid = fopen(['/Users/bcbirkel/Documents/GitHub/LABasin/Hercules/currentSim/ObsData/Velocity/' PZ_Files(nf).name]);
    ...
    for nr = 1:size(In,1)-1
        ...
        for nc = 1:In(nr+1)-In(nr)
            ...
            SAC_File = dir(['/Users/bcbirkel/Documents/GitHub/LABasin/Hercules/currentSim/ObsData/Velocity/' ...
            ...
            if size(SAC_File,1) == 0
                ...
                system(['rm -r /Users/bcbirkel/Documents/GitHub/LABasin/Hercules/currentSim/ObsData/Velocity/' ...
                       PZ_Files(In(nr)+nc-1).name]);
                
            else
                % If file exists, load observed seismogram
                Sac = rsac('little-endian',['/Users/bcbirkel/Documents/GitHub/LABasin/Hercules/currentSim/ObsData/Velocity/' ...
                    R_Ntw{In(nr)+nc-1} '.' R_Code{In(nr)+nc-1} '.' R_Loc{In(nr)+nc-1} '.' R_Chn{In(nr)+nc-1} ...
                    '.D.' num2str(Eqk(nS).Year)  '.' num2str(Eqk(nS).JDay,'%03d') '.' ...
                    num2str(Eqk(nS).Hour,'%02d') num2str(Eqk(nS).Min,'%02d') num2str(Eqk(nS).Sec,'%02d') '.SAC']);
                ...
                if Signal/Noise < 8
                    ...
                    system(['rm -r /Users/bcbirkel/Documents/GitHub/LABasin/Hercules/currentSim/ObsData/Velocity/' PZ_Files(In(nr)+nc-1).name]);
                end
            end
        end
    end
