function [head1, head2, head3, data]=sac(filename,computer)
...
fid=fopen(filename, 'rb',computer);
...
head1=fread(fid, [5, 14], 'float32',computer);
head2=fread(fid, [5, 8], 'int32',computer);
head3=fread(fid, [24, 8], 'char',computer);
head1=head1'; head2=head2'; head3=head3';
npts=head2(2, 5);
data=fread(fid, npts, 'float32',computer);
