...
for nS = 1:size(Eqk,1)
    ...
    Fid1 = fopen(['/home/scec-00/birkel/EarthquakePhysics/Codes/AuxFiles/' ...
        num2str(Eqk(nS).Year) num2str(Eqk(nS).Month,'%02d') num2str(Eqk(nS).Day,'%02d') ...
        num2str(Eqk(nS).Hour,'%02d') num2str(Eqk(nS).Min,'%02d') num2str(Eqk(nS).Sec,'%02d') ...
        '.sitechan'],'w');
    
    % Open StationChanel.txt
    Fid3 = fopen(['/home/scec-00/birkel/EarthquakePhysics/Codes/AuxFiles/' ...
        num2str(Eqk(nS).Year) num2str(Eqk(nS).Month,'%02d') num2str(Eqk(nS).Day,'%02d') ...
        num2str(Eqk(nS).Hour,'%02d') num2str(Eqk(nS).Min,'%02d') num2str(Eqk(nS).Sec,'%02d') ...
        '_STN.txt'],'w');
    
    % Save short.site
     Fid2 = fopen(['/home/scec-00/birkel/EarthquakePhysics/Codes/AuxFiles/' ...
        num2str(Eqk(nS).Year) num2str(Eqk(nS).Month,'%02d') num2str(Eqk(nS).Day,'%02d') ...
        num2str(Eqk(nS).Hour,'%02d') num2str(Eqk(nS).Min,'%02d') num2str(Eqk(nS).Sec,'%02d') ...
        '.site'],'w');
    ...
    for nr = 1:size(In,1)-1
        ...
        for nc = 1:In(nr+1)-In(nr)
                ...
                Wave(nc,:) = transfer(W.*rtrend(Sac(1:NT)),NT,1/Dt,['/home/scec-00/birkel/EarthquakePhysics/ObservedData/' ...
                        num2str(Eqk(nS).Year) num2str(Eqk(nS).Month,'%02d') num2str(Eqk(nS).Day,'%02d') ...
                        num2str(Eqk(nS).Hour,'%02d') num2str(Eqk(nS).Min,'%02d') num2str(Eqk(nS).Sec,'%02d') ...
                        '/SCEDC/'  PZ_Files(In(nr)+nc-1).name],FMin,FMax);
        end
