    ...
    for nr = 1:size(In,1)-1
        ...
        for nc = 1:In(nr+1)-In(nr)
            ...
            if size(SAC_File,1) == 0
                ...
                system(['rm -r /Users/bcbirkel/Documents/GitHub/LABasin/Hercules/currentSim/ObsData/Velocity/SACPZ/' ...
                ...
                if Signal/Noise < 3 
                    ...
                    system(['rm -r' SAC_Path]);
                    
                    system(['rm -r /Users/bcbirkel/Documents/GitHub/LABasin/Hercules/currentSim/ObsData/Velocity/SACPZ/' PZ_Files(In(nr)+nc-1).name]);
                end
            end
        end
    end
