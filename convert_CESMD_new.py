...
path_dir_CESMD = "/Users/bcbirkel/Library/Mobile Documents/com~apple~CloudDocs/Documents/GitHub/LABasin/CompiledEvents/" + event + '/CESMD/'
...
v3fol = path_dir_CESMD + "V3/"
if os.path.isdir(v3fol) == True:
    shutil.rmtree(v3fol)
if os.path.isdir(v3fol) == False:
    os.mkdir(v3fol)
       ...
       if name.endswith(".zip") == True or name.endswith(".ZIP") == True:
           ...
           with unzip(zipfol,'r') as zfol:
               ...
               for file in os.listdir("."):
                    ...
                    if file.endswith(".V3") == True:
                        os.rename(file, v3fol + file)
...
for file in file_list:
    if file.startswith("CHAN") == False:
        ...
        lowfreq = lines[14].split()[8]
        highfreq = lines[14].split()[10]
        ...
        for ii in range(9):
            ...
            tr.stats.sac.kuser2 = "bandpass = " + lowfreq + "-" + highfreq + "Hz"
            ...
            os.chdir("/Users/bcbirkel/Library/Mobile Documents/com~apple~CloudDocs/Documents/GitHub/LABasin/CompiledEvents/" + event + '/CESMD/SAC/')
        ...
        if file.startswith("CHAN") == True:
            ...
            for ii in range(3):
                ...
                tr.stats.sac.leven = True
                tr.stats.starttime = starttime 
                tr.stats.sac.user0 = "lowpass = " + lowfreq 
                tr.stats.sac.user1 = "highpass = " + highfreq 
...
for f in os.listdir(path_dir_CESMD + 'SAC/'):
    if f.endswith("acc.SAC"):
        os.rename(f, path_dir_CESMD + 'SAC/acc/' + f)
    if f.endswith("vel.SAC"):
        os.rename(f, path_dir_CESMD + 'SAC/vel/' + f)
    if f.endswith("disp.SAC"):
        os.rename(f, path_dir_CESMD + 'SAC/disp/' + f)
